...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '8fc4ba22-3cb6-11f1-8ce1-bcfce7007cc7:1-61';
...
CREATE TABLE `company_profile` (
  ...
  CONSTRAINT `fk_id_admin` FOREIGN KEY (`id_user`) REFERENCES `admin` (`id_admin`)
...
INSERT INTO `history_purchase` VALUES (1,1,1,1,'2026-06-17 00:00:00','2026-06-17 00:00:00','2026-06-18 00:00:00',500000.00,'confirmed');
...
INSERT INTO `session_login` VALUES (2,1,'customer','inactive','2026-04-21 19:39:19','2026-04-21 19:39:19','2026-04-21 21:29:16'),(3,1,'customer','active','2026-04-21 21:29:16','2026-04-21 21:29:16',NULL),(4,2,'customer','active','2026-05-20 23:20:45','2026-05-20 23:20:45',NULL);
...
INSERT INTO `user` VALUES (1,'Michael','customer','0812121232','mich@gmail.com','mich123'),(2,'Bagas Yoga','customer','081234567890','bagas@example.com','password123');
